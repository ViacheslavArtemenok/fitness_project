...
return [
    ...
    'account' => [
        ...
        'gyms' => [
            'create' => ['success' => 'Данные зала успешно добавлены',
                'fail' => 'Не удалось добавить данные зала',
            ],
            'update' => [
                'success' => 'Данные зала успешно обновлены',
                'fail' => 'Не удалось обновить данные зала'
            ],
        ],
        'gym_addresses' => [
