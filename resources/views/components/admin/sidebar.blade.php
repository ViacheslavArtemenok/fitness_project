<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.changePassword')) active @endif" aria-current="page"
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.skills.*')) active @endif"
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.relations.*')) active @endif"
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.characteristics.*')) active @endif"
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.gyms.*')) active @endif"
                   href="{{ route('admin.gyms.index') }}">
                    <span data-feather="file" class="align-text-bottom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tencent-qq"
                            viewBox="0 0 16 16">
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.gymAddresses.*')) active @endif"
                   href="{{ route('admin.gymAddresses.index') }}">
                    <span data-feather="file" class="align-text-bottom">
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->routeIs('admin.gymImages.*')) active @endif"
                   href="{{ route('admin.gymImages.index') }}">
                    <span data-feather="file" class="align-text-bottom">
