...
<div class="admin_header">
    <div class="p-4 p-md-5 mb-0 text-bg-dark w-100" style="background-image: url('assets/images/admin_index.jpg');">
        <div class="col-md-6 px-0">
            ...
            <p class="lead my-3">Административная панель доступа к данным пользователей и разделам сайта. Добавляйте,
    ...
    <div class="container px-4 py-5" id="icon-grid">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
            @foreach ($menuList as $key => $item)
                <a href="{{ route($item['url']) }}" class="col d-flex align-items-start text-decoration-none"
