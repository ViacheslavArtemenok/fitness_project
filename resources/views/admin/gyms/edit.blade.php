...
@section('content')
    <div class="offset-2 col-8">
        ...
        <form method="post" action="{{ route('admin.gyms.update', ['gym' => $gym]) }}"
            enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="form-group">
                <label for="user_id">Идент пользоват</label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone_main" id="phone_mask" placeholder="+7 (900) 123-45-67"
                    value="{{ $gym->phone_main }}">
            </div>
            <div class="form-group">
                <label for="phone_mask1">Дополнительный телефон</label>
                <input type="text" class="form-control" name="phone_second" id="phone_mask1" placeholder="+7 (900) 123-45-67"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="description" id="description" value="{{ $gym->description }}">
            </div>
            <br>
