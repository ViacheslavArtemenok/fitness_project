...
@section('content')
    <div class="offset-2 col-8">
        ...
        <form method="post" action="{{ route('admin.characteristics.update', ['characteristic' => $characteristic]) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="height" id="height" value="{{ $characteristic->height }}">
            </div>
            <div class="form-group">
                <label for="weight">Вес</label>
                <input type="text" class="form-control" name="weight" id="weight" value="{{ $characteristic->weight }}">
            </div>
            <div class="form-group">
