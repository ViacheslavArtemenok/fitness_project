    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body d-flex flex-column justify-content-center align-items-stretch flex-wrap">
                ...
                <form class="w-100" method="POST" action="{{ route('trainerReviews.store') }}">
                    @csrf
                    <div class="d-flex flex-column justify-content-center align-items-center">
                        <input id="client_id" type="number" name="client_id" value="{{ Auth::user()->id }}" required
                            hidden>
                        <input id="trainer_id" type="number" name="trainer_id" value="{{ $trainer->id }}" required
                            hidden>
                        <input id="status" type="text" name="status" value="DRAFT" required hidden>
