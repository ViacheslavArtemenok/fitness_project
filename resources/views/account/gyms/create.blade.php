        ...
        <div class="offset-2 col-8">
            ...
            <form method="post" action="{{ route('account.gyms.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control mask-phone" name="phone_main" id="phone_main" data-format="+7 (ddd) ddd-dd-dd"
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control mask-phone" name="phone_second" id="phone_second" data-format="+7 (ddd) ddd-dd-dd"
